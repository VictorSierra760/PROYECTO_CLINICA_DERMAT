          ...
          <form method="POST" id="frmnuevo" name="frmnuevo" action="paciente" class="needs-validation" novalidate>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="prim_nombre" name="prim_nombre" required autofocus>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="prim_apellido" name="prim_apellido" required autofocus>
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                <label>Género</label>
                <select class="form-control" style="width: 100%;" name="genero" required autofocus>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control" id="fech_nacimiento" name="fech_nacimiento" required autofocus>
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="num" class="form-control" id="edad" name="edad" pattern="[1-9]+" required autofocus>
                <div class="valid-feedback">¡Ok válido!</div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="tipo_id" name="tipo_id" required autofocus>
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input maxlength="15" type="text" class="form-control" id="num_id_pac" name="num_id_pac" required autofocus>
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <select class="form-control" style="width: 100%;" name="estado" required autofocus>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="tel_pac" name="tel_pac" required autofocus>
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="direccion" name="direccion" required autofocus>
                <div class="valid-feedback">¡Ok válido!</div>
                <div class="invalid-feedback">Complete el Campo!</div>
              </div>
              ...
              <div class="form-group col-md-4">
                ...
                <select class="form-control" style="width: 100%;" name="departamento" required autofocus>
